    ...
    return players.map(player => (
      <tr key={player._id} className="">
        ...
        <td
          ...
          title={"Click here to see details about " + player.name}
        >
          {player.name}
        </td>
      ...
      <div>
        ...
        <div className="container">
          <div className="col 12">
            <h4 className="center green-text darken-1 team">
              {" "}
              {name} currently has <span className="red-text">{score} </span>Points
            </h4>
